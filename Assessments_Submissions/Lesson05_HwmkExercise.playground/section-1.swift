...
func whoIsHere (firstName:String, homeCountry:String) {
    println("It's me, \(firstName) from \(homeCountry)")
}
var firstName = "Megan"
var homeCountry = "USA"
whoIsHere(firstName, homeCountry)
...
func calculateAge (yearOfBirth:Int) {
    println("It's Megan, born in \(yearOfBirth)")
...
//tellNameAndAge(name, yearOfBirth)
